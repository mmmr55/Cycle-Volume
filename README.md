# Cycle-Volume
生育与Fill Her Up的集成，依赖LIFng，且使用Sexlab p+为接口，DLL模式
关于本项目
...
关于响应延迟：我和作者不在同一个市区/时区，无法第一时间看到并回复他的信息。如果因此被判定为我的过错，那我接受这个结论，也没什么好争辩的。
代码逻辑：该项目不包含任何他人的代码实现。虽然我承认“概念逻辑”受到了影响（被污染），本打算重构，但现在觉得随便了。
